...
// Regex to capture the grid contents, accounting for all spacing variations
const gridRegex = /(<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">)([\s\S]*?)(<div class="mt-16 p-8 bg-indigo-950\/20)/;
...
if (gridRegex.test(content)) {
    ...
    console.log("Could not find grid matching the regex.");
}
