                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <ul className="space-y-2">
                                                    ...
                                                    <li className="text-sm text-slate-400 hover:text-white transition-colors cursor-pointer block py-1">• Feel Sharp</li>
                                                    <li className="text-sm text-slate-400 hover:text-white transition-colors cursor-pointer block py-1">• Create Your Learning Lab</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <ul className="space-y-2">
                                                    <li className="text-sm text-slate-400 hover:text-white transition-colors cursor-pointer block py-1">• Your Social Circle</li>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <ul className="space-y-2">
                                                    ...
                                                    <li className="text-sm text-slate-400 hover:text-white transition-colors cursor-pointer block py-1">• Preview the Material</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
