                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-4 max-w-2xl mx-auto lg:mx-0 pt-2">
                                    ...
                                    <p className="text-base md:text-lg text-slate-400 font-light leading-relaxed">
                                        Our goal is to empower you to master deep comprehension in the most efficient way. Using scientifically proven meta-learning protocols we will help you to maximize your reading speed (most people double their speed), master memory retention, and turn study material into lasting expertise.
                                    </p>
                                </div>
