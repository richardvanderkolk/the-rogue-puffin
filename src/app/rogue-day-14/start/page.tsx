...
function RogueDay14SessionContent() {
    ...
    const dashboardUrl = `/rogue-graduation?course=${course}`;
    ...
    const markCompleteAndReturn = async () => {
        ...
        if (14 >= currentProgress) {
            localStorage.setItem('rogue_day_progress', '15');
        }
        try {
            await updateBootcampProgress(15);
        } catch (error) {
                            ...
                            <div className="w-full flex flex-col pb-8">
                                <div className="w-full relative z-0">
                                    <div
                                        ...
                                        dangerouslySetInnerHTML={{ __html: getArticleVariant('day-14-community', activeArchetype) }}
                                    />
                                </div>
                                {archetypes.length > 1 && (
