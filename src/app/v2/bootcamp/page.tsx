...
export default async function BootcampDashboard(props: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    const days = [
        ...
        { day: 11, title: "The Feynman Technique", desc: "The illusion of knowledge", icon: <MessageCircle className="w-5 h-5" />, status: isUnlocked ? "available" : "locked", link: "/rogue-day-11/start?course=bootcamp" },
