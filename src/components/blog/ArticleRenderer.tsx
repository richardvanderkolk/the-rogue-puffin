            ...
            {mounted && hasAccess && !user && (
                <div className="mt-16 pt-16 border-t border-slate-800 print:hidden relative z-10 bg-slate-950">
                    ...
                    <Link href="/rogue-session/start" className="block p-8 rounded-2xl bg-indigo-900/30 border border-indigo-500/30 hover:border-indigo-500/50 hover:bg-indigo-900/40 transition-all group shadow-lg shadow-indigo-500/10">
                        ...
                        <h4 className="text-2xl md:text-3xl font-bold text-white mb-3 group-hover:text-indigo-300 transition-colors">Free Interactive Training to Maximize Your Reading Speed <span className="text-indigo-500 ml-2">→</span></h4>
                        <p className="text-slate-400 font-light text-lg">Experience the exact visual pacing protocol used by top performers. This free 15-minute session forces your brain out of subvocalization and permanently maximizes your reading speed.</p>
                    </Link>
                </div>
            )}
        </div>
