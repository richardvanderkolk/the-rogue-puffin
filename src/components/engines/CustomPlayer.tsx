...
interface CustomPlayerProps {
    text: string;
    wpm: number;
    mode: 'flash' | 'peripheral' | 'bionic';
    bionicContinuous?: boolean;
}

export default function CustomPlayer({ text, wpm, mode, bionicContinuous = false }: CustomPlayerProps) {
    ...
    const showControls = !(mode === 'bionic' && bionicContinuous);
            ...
            <div className="w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-3xl p-4 md:p-8 shadow-2xl relative">
                ...
                <div className="absolute top-4 left-4 md:top-8 md:left-8 z-50 flex items-center gap-4">
                     <div className="text-left">
                        <div className="text-sm font-mono font-bold text-slate-300">
                            {mode === 'flash' ? 'Kinetic' : mode === 'peripheral' ? 'Peripheral' : bionicContinuous ? 'Bionic Reader' : 'Bionic RSVP'}
                        </div>
                ...
                <div className="mt-12 md:mt-0">
                    <PacerEngine
                        ...
                        bionicContinuous={bionicContinuous}
