        ...
        <header className="print:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-slate-950/80 backdrop-blur-md border-b border-white/5">
            <Link href="/" className="flex items-center gap-3 md:gap-4 group">
                ...
                <div className="relative w-56 h-24 md:w-72 md:h-28">
                    <img src="/assets/premium-text-transparent.png" alt="The Rogue Puffin Learning Mastery" className="object-contain object-left w-full h-full opacity-95 group-hover:opacity-100 transition-all duration-300 drop-shadow-lg origin-left" />
                </div>
            </Link>
